...
const release = (): Release => ({
  ...
  teamId: 't',
  workStreams: [
    { id: 'ws1', name: 'Payments', externalId: null, engineersRequired: null, build: null, externalUrl: null },
    { id: 'ws2', name: 'Auth', externalId: null, engineersRequired: null, build: null, externalUrl: null },
  ],
  events: [],
