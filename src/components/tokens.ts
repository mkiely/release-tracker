...
export const WF = {
  ...
  status: {
    ...
    'In Progress':   { dot: 'var(--rt-st-ac-dot)', soft: 'var(--rt-st-ac-soft)', text: 'var(--rt-st-ac-text)' },
    'Under Review':  { dot: 'var(--rt-st-ur-dot)', soft: 'var(--rt-st-ur-soft)', text: 'var(--rt-st-ur-text)' },
