...
export const Icon: Record<string, ReactElement> = {
  chevDown: <svg width="13" height="13" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.45" strokeLinecap="round"><path d="M2.5 4.5L6 8l3.5-3.5" /></svg>,
  chevRight: <svg width="13" height="13" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.55" strokeLinecap="round"><path d="M4.5 2.5L8 6l-3.5 3.5" /></svg>,
  chevLeft: <svg width="14" height="14" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.55" strokeLinecap="round"><path d="M7.5 2.5L4 6l3.5 3.5" /></svg>,
  ...
  edit: <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"><path d="M9.3 2.4l2.3 2.3M10.2 1.5a1.2 1.2 0 0 1 1.7 1.7L4.4 10.7 1.8 11.5l.8-2.6 7.6-7.4z" /></svg>,
  sun: <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round"><circle cx="8" cy="8" r="3.1" /><path d="M8 1.4v1.7M8 12.9v1.7M1.4 8h1.7M12.9 8h1.7M3.3 3.3l1.2 1.2M11.5 11.5l1.2 1.2M12.7 3.3l-1.2 1.2M4.5 11.5l-1.2 1.2" /></svg>,
  moon: <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round"><path d="M13.5 9.4A5.6 5.6 0 0 1 6.6 2.5a5.6 5.6 0 1 0 6.9 6.9z" /></svg>,
  ...
  stream:  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"><rect x="2.4" y="3.3" width="11.2" height="2.5" rx="1.25"/><rect x="2.4" y="6.75" width="7.4" height="2.5" rx="1.25"/><rect x="2.4" y="10.2" width="9.6" height="2.5" rx="1.25"/></svg>,
  ...
  sliders: <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round"><line x1="2" y1="4.5" x2="14" y2="4.5"/><line x1="2" y1="8" x2="14" y2="8"/><line x1="2" y1="11.5" x2="14" y2="11.5"/><circle cx="5.5" cy="4.5" r="2" fill="var(--rt-paper)" strokeWidth="1.25"/><circle cx="10.5" cy="8" r="2" fill="var(--rt-paper)" strokeWidth="1.25"/><circle cx="7" cy="11.5" r="2" fill="var(--rt-paper)" strokeWidth="1.25"/></svg>,
